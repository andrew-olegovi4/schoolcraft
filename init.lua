...
dofile(minetest.get_modpath("school_furniture") .. DIR_DELIM .. "schooldrawings/colorful_drawings.lua")
dofile(minetest.get_modpath("school_furniture") .. DIR_DELIM .. "programmer_block.lua")
